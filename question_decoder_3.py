...
def run_qdec(question, graph):
    movie = pd.read_csv("/Users/sanjanawarambhey/Downloads/atai_conv_agent/subjects.csv")

    relations = pd.read_csv("/Users/sanjanawarambhey/Downloads/atai_conv_agent/predicates.csv")
    ...
    try:
        ...
        final_answer = "The answer for your question is %s"%(temp[1][0])
        ...
        entity_emb = np.load('/Users/sanjanawarambhey/Downloads/ddis-graph-embeddings/entity_embeds.npy')
        relation_emb = np.load('/Users/sanjanawarambhey/Downloads/ddis-graph-embeddings/relation_embeds.npy')

    
        with open('/Users/sanjanawarambhey/Downloads/ddis-graph-embeddings/entity_ids.del', 'r') as ifile:
            ent2id = {rdflib.term.URIRef(ent): int(idx) for idx, ent in csv.reader(ifile, delimiter='\t')}
            id2ent = {v: k for k, v in ent2id.items()}
        with open('/Users/sanjanawarambhey/Downloads/ddis-graph-embeddings/relation_ids.del', 'r') as ifile:
